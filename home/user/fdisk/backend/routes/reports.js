...
router.get('/', async (req, res) => {
    try {
        ...
        const formattedReports = reports.map(report => {
            // Format date for display in table using German format (DD.MM.YYYY)
            ...
            return {
                ...report,
                displayDate,  // For table display (DD.MM.YYYY)
                date: report.date, // Keep original date for form input
